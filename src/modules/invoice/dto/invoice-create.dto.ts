// Use a local no-op `ApiProperty` decorator here to avoid strict decorator
// typing issues during the type-check. This is a temporary measure —
// production Swagger decorators are kept in other files.
